...
class NT2NBaseAttentionLayerNormalizedModel(CombinedModule):
    ...
    def __init__(
        ...
        super().__init__()
        print('NT2NBaseAttentionLayerNormalizedModel created!')
        ...
        self.recurrent_norm = self.torch_module(LayerNorm(normalized_shape=self.hidden_dim))
    ...
    def get_recurrent_layers_outputs(
        ...
        for i in range(combined_input.size()[0]):
            ...
            cur_h = self.recurrent_norm(cur_h)
            hidden = (cur_h, cur_c)
