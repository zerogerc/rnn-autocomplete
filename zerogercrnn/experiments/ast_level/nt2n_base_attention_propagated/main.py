...
from zerogercrnn.experiments.ast_level.nt2n_base_attention_propagated.model import NT2NBaseAttentionPropaGatedBufferModel
...
class GatedLoss(NonTerminalsCrossEntropyLoss):
    def __init__(self, model: NT2NBaseAttentionPropaGatedBufferModel):
        super().__init__()
        self.model = model
        self.it = 0
...
class NT2NBaseAttentionPropaGatedBufferMain(ASTMain):
    def create_model(self, args):
        return NT2NBaseAttentionPropaGatedBufferModel(
