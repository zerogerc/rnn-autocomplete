...
from zerogercrnn.experiments.ast_level.attention_nt2n.main import NT2NAttentionMain
...
parser.add_argument('--prediction', type=str, help='One of: nt2n, attn_nt2n nt2nt, ntn2t')
...
def get_main(args):
    if args.prediction == 'nt2n':
        main = NT2NMain(args)
    elif args.prediction == 'attn_nt2n':
        main = NT2NAttentionMain(args)
