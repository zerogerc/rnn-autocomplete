...
def run_model(model, iter_num, iter_data, hidden, seq_len, batch_size, cuda):
    logger.reset_time()
...
class NTASTRoutine(NetworkRoutine):
    def __init__(self, model: NTModel, seq_len, batch_size, criterion, optimizers=None, cuda=True):
